...
module.exports = {
  ...
  // updateAcModel: (acName, acEmail, acPhone, acPassword, acLevel, acId) => {
  //   return new Promise((resolve, reject) => {
  //     db.query(`UPDATE account SET ac_name = '${acName}', ac_email = '${acEmail}',
  //     ac_phone = '${acPhone}',ac_password = '${acPassword}', ac_level = ${acLevel} WHERE ac_id = ${acId}`, (err, result, fields) => {
  //       if (!err) {
  //         resolve(result)
  //       } else {
  //         reject(new Error(err))
